...
def main() -> int:
    ...
    env_camera.setdefault("CFRS_FRAME_RESIZE_SCALE", "0.42")
    env_camera.setdefault("CFRS_PROCESS_EVERY_N_FRAMES", "3")
    env_camera.setdefault("CFRS_BODY_DETECT_EVERY_N_FRAMES", "4")
    env_camera.setdefault("CFRS_BODY_RESIZE_SCALE", "0.4")
